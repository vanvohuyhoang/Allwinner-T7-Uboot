...
void set_pll_cpux_axi(void)
{
	...
	/* set factor n=250 */
	set_factor_n(250, CCMU_PLL_CPUX_CTRL_REG);
	...
	/* set factor n=80 */
	set_factor_n(80, CCMU_PLL_CPUX_CTRL_REG);
	...
	/* set default factor n=0x10 */
	set_factor_n(0x10, CCMU_PLL_CPUX_CTRL_REG);
...
void set_pll_periph0(void)
{
	...
	/* set factor n=250 */
	set_factor_n(250, CCMU_PLL_PERI0_CTRL_REG);
	...
	/* set factor n=80 */
	set_factor_n(80, CCMU_PLL_PERI0_CTRL_REG);
	...
	/* set default factor n=0x31 */
	set_factor_n(0x31, CCMU_PLL_PERI0_CTRL_REG);
